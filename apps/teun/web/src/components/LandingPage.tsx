...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-page-bg overflow-y-auto">
      <div className="flex flex-col items-center justify-center py-14 px-4 max-w-[960px] mx-auto">
        ...
        {/* Subtitle */}
        <p className="animate-fade-up text-[17px] text-gray text-center mb-6 font-normal leading-[1.6]" style={{ animationDelay: "0.4s" }}>
        ...
        {/* Start button */}
        <div className="animate-fade-up mb-12" style={{ animationDelay: "0.45s" }}>
          <button
            onClick={() => navigate("/chat")}
            className="inline-flex items-center gap-2 px-8 py-3 bg-accent text-white font-semibold text-sm rounded-xl hover:bg-accent-dark transition-colors shadow-[0_2px_8px_rgba(0,214,150,0.3)]"
          >
            Start een gesprek
        ...
        <div className="animate-fade-up flex gap-4 w-full max-w-[840px] mb-12 items-start relative max-md:flex-col" style={{ animationDelay: "0.5s" }}>
          ...
          <div className="flex-1 min-w-0 bg-surface rounded-xl border border-border overflow-hidden shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
            ...
            {/* Chat input — clicking navigates to chat */}
            <div
              onClick={() => navigate("/chat")}
              className="flex items-center gap-2.5 px-6 py-3.5 border-t border-border cursor-pointer hover:bg-surface-hover transition-colors"
            >
              <span className="flex-1 text-[13px] text-gray-light">Stel je vraag aan Teun...</span>
              <div className="w-[34px] h-[34px] rounded-lg bg-accent flex items-center justify-center shrink-0 hover:bg-accent-dark transition-colors">
        ...
        {/* MUNT Footer */}
        <div className="animate-fade-up mt-14 flex flex-col items-center gap-3" style={{ animationDelay: "1.4s" }}>
          <img src="/logo-munt-1-1.png" alt="MUNT Hypotheken" className="h-10" />
          <p className="text-[11px] text-gray-light">&copy; {new Date().getFullYear()} MUNT Hypotheken</p>
        </div>
